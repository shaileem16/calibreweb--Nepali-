...
class Authors(Base):
    ...
    def __repr__(self):
        return "<लेखकहरू('{0},{1}{2}')>".format(self.name, self.sort, self.link)
...
class Publishers(Base):
    ...
    def __repr__(self):
        return "<प्रकाशकहरू('{0},{1}')>".format(self.name, self.sort)
...
class Books(Base):
    ...
    def __repr__(self):
        return "<पुस्तकहरू('{0},{1}{2}{3}{4}{5}{6}{7}{8}')>".format(self.title, self.sort, self.author_sort,
